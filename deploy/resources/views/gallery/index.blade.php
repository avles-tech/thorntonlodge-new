                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="clearfix">
                                <a href="/gallerySection/create" class="btn btn-sm btn-success btn-space"><i class="ace-icon fa fa-upload bigger-80"></i> Upload Images</a>
                                <a href="/gallerySection" class="btn btn-space btn-sm  btn-info"><i class="ace-icon fa fa-refresh bigger-80"></i> Reload</a>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                @if(count($galleries)>0)
                                    @foreach($galleries as $k=> $gallery)
                                        <tr>
                                            <td>{{ ($k+1) }}</td>
                                            <td>
                                                <img width="100px" height="70px" alt="{{$gallery->title}}" src="/Uploads/gallery_images/thumbnail/{{$gallery->image}}" />
                                            </td>
                                            <td><div class="truncate-ellipsis-title">{{ $gallery->title }}</div></td>
                                            ...
                                            <td>
                                                <div class="action_button">
                                                    ...
                                                    <a  title="Edit" class="label label-success lbl_pad" href="/gallerySection/{{$gallery->id}}/edit">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a title="Delete" data-toggle="modal" onclick="delete_data('{{ $gallery->id }}','{{ $gallery->title }}')" data-target=".bs-delete-modal-sm" class="label label-danger lbl_pad" href="#">
                                ...
                                @else
                                    <div class="alert alert-danger">
                                        ...
                                        No project image results found!
                                        <br/>
                                    </div>
                                @endif
                                </tbody>
...
@section('extra_script')
    ...
    <script type="text/javascript">
        function delete_data(id,title) {
            var getid='Image ID: '+id;
            var tagname='Tag: '+title;
            ...
            $( ".id-btn-delete" ).on('click', function(e) {
                location.href = '/gallerySection/'+id+'/delete';
            });
        }
        function delete_all_data() {
            location.href = '/gallerySection/delete/bulk-delete';
        }
    </script>
@endsection
