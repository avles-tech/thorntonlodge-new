...
@section('content')
    ...
    <div class="right_col" role="main">
        ...
        <div class="">
            ...
            {!! Form::open(['action' => 'PostController@store', 'class' => 'form-horizontal form-label-left','role' => 'form', 'method' => 'POST', 'enctype'=>'multipart/form-data']) !!}
            <div class="row">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                                    ...
                                    <select class="form-control" name="category_id" data-placeholder="Choose type...">
                                        @if(count($tags)>0)
                                            @foreach($tags as $k=> $tag)
                                                <option value="{{ $tag->id }}" <?php if($k ==0){ echo 'selected';} ?>>{{ $tag->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" required name="title" value=""  placeholder="Post title ..." class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" name="author" value="Admin"  placeholder="Author Name ..." class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <br/>
                                    <input type="checkbox" name="featured" class="flat" checked="checked">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="form-group">
                                {{ Form::textarea('body','',['id'=>'article-ckeditor', 'required','placeholder'=>'About Post Content ...', 'class'=>'col-xs-12 col-sm-12', 'row'=>'9'])}}
                            </div>
                        </div>
                    </div>
                </div>
