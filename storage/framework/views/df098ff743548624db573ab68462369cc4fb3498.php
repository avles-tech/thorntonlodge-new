            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 text-center hero-content">
                    ...
                    <div style="margin-top: 60px;">
                        <a href="<?php echo e(route('about')); ?>" class="ripple" style="display: inline-block; background: white; color: #7BA5C7; padding: 22px 55px; border-radius: 50px; text-decoration: none; font-weight: 700; font-size: 18px; margin: 0 15px 20px 15px; box-shadow: 0 8px 30px rgba(0, 0, 0, 0.25); transition: all 0.3s ease; text-transform: uppercase; letter-spacing: 1px;">
                            <i class="fa fa-info-circle" style="margin-right: 12px;"></i>Learn More About Us
                        </a>
                        <a href="<?php echo e(route('contact')); ?>" class="ripple" style="display: inline-block; background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(15px); color: white; padding: 22px 55px; border-radius: 50px; text-decoration: none; font-weight: 700; font-size: 18px; margin: 0 15px 20px 15px; box-shadow: 0 8px 30px rgba(0, 0, 0, 0.2); border: 2px solid rgba(255, 255, 255, 0.5); transition: all 0.3s ease; text-transform: uppercase; letter-spacing: 1px;">
        ...
        <div class="container-fluid" style="max-width: 1600px; padding: 0 20px;">
            <div class="scroll-animate-zoom">
                ...
                <div class="video-wrapper" style="position: relative; border-radius: 25px; overflow: hidden; box-shadow: 0 15px 60px rgba(0,0,0,0.15); max-width: 100%;">
                    <video width="100%" loop muted poster="<?php echo e(asset('images/THORNTON_LODGE_THUMBNAIL.png')); ?>" onclick="this.controls=true; this.play();" style="display: block;">
    ...
    <section style="background: linear-gradient(135deg, #F0F7FA 0%, #E8F4F8 100%); padding: 100px 0;">
        <div class="container-fluid" style="max-width: 1600px; padding: 0 20px;">
            <div class="scroll-animate-zoom">
                ...
                <div class="video-wrapper" style="position: relative; border-radius: 25px; overflow: hidden; box-shadow: 0 15px 60px rgba(0,0,0,0.15); max-width: 100%;">
                    <video width="100%" loop muted poster="<?php echo e(asset('images/THORNTON_LODGE_JOE.png')); ?>" onclick="this.controls=true; this.play();" style="display: block;">
                                    ...
                                    <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="testimonial-slide">
                                            <div style="background: rgba(255,255,255,0.98); padding: 60px 50px; border-radius: 30px; box-shadow: 0 20px 60px rgba(0,0,0,0.2); position: relative; min-height: 250px; display: flex; align-items: center; backdrop-filter: blur(10px);">
                                                ...
                                                <p style="padding: 0; background: transparent; border: none; box-shadow: none; line-height: 2; font-size: 20px; margin: 35px 0 0 0; color: #333; text-align: center; font-weight: 400;"><?php echo e($testimonial->comment); ?></p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 featured-content scroll-animate-zoom" style="margin-bottom: 40px;">
                                        <div class="ripple" style="background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 8px 30px rgba(0,0,0,0.12); transition: transform 0.3s ease, box-shadow 0.3s ease; height: 100%; position: relative; cursor: pointer;">
                                            ...
                                            <div class="property-info-list" style="padding: 25px;">
                                                ...
                                                <a href="<?php echo e(route('contact')); ?>" class="ripple" style="display: inline-block; background: #7BA5C7; color: white; padding: 10px 25px; border-radius: 25px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(110, 207, 233, 0.3);">Enquire Now</a>
                                            </div>
                                            <!--//Property_info-->
                                        </div>
                                    </div>
