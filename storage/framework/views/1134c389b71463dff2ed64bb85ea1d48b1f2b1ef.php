        ...
        <div style="display: flex; align-items: center; gap: 0;">
            ...
            <ul class="clean-nav-menu">
                <li class="clean-nav-item active">
                    <a href="<?php echo e(route('home')); ?>" class="clean-nav-link">HOME</a>
                </li>

                <li class="clean-nav-item">
                    <a href="<?php echo e(route('about')); ?>" class="clean-nav-link">
                        ABOUT
                        <span class="dropdown-arrow">▼</span>
                    </a>
                    <div class="clean-dropdown">
                        <a href="<?php echo e(route('about')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-info-circle"></i>Who We Are
                        </a>
                        <a href="<?php echo e(route('testimonial')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-quote-left"></i>Testimonials
                        </a>
                        <a href="<?php echo e(route('team')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-users"></i>Team
                        </a>
                        <a href="<?php echo e(route('job_vacancy')); ?>" class="clean-dropdown-item">
                ...
                <li class="clean-nav-item">
                    <a href="<?php echo e(route('accommodation')); ?>" class="clean-nav-link">
                        THE LODGE
                        <span class="dropdown-arrow">▼</span>
                    </a>
                    <div class="clean-dropdown">
                        <a href="<?php echo e(route('accommodation')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-hotel"></i>Accommodation
                        </a>
                        <a href="<?php echo e(route('admission')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-plus-circle"></i>Admission Criteria
                        </a>
                        <a href="<?php echo e(route('facilities')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-thumbs-o-up"></i>Facilities
                        </a>
                        <a href="<?php echo e(route('cuisine')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-cutlery"></i>Cuisine
                        </a>
                        <a href="<?php echo e(route('activities')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-bar-chart-o"></i>Activities & Events
                        </a>
                        <a href="<?php echo e(route('principal')); ?>" class="clean-dropdown-item">
                            <i class="fa fa-hospital-o"></i>Principal of Care
                        </a>
                        <a href="<?php echo e(route('staff_training')); ?>" class="clean-dropdown-item">
                ...
                <li class="clean-nav-item">
                    <a href="<?php echo e(route('vacancies')); ?>" class="clean-nav-link">BED AVAILABILITY</a>
                </li>

                <li class="clean-nav-item">
                    <a href="<?php echo e(route('gallery')); ?>" class="clean-nav-link">GALLERY</a>
                </li>

                <li class="clean-nav-item">
                    <a href="<?php echo e(route('contact')); ?>" class="clean-nav-link clean-cta-button">CONTACT US</a>
                </li>
            </ul>
        </div>
    </div>
