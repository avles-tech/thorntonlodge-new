            ...
            <div style="display: flex; align-items: center; justify-content: space-between; position: relative;">
                ...
                <ul class="modern-nav-menu">
                    <li class="modern-nav-item active">
                        <a href="<?php echo e(route('home')); ?>" class="modern-nav-link">Home</a>
                    </li>

                    <li class="modern-nav-item">
                        <a href="<?php echo e(route('about')); ?>" class="modern-nav-link modern-dropdown-toggle">About</a>
                        <div class="modern-dropdown-menu">
                            <a href="<?php echo e(route('about')); ?>" class="modern-dropdown-item">
                                <i class="fa fa-info-circle" style="margin-right: 8px; color: #6ecfe9;"></i>Who We Are
                            </a>
                            <a href="<?php echo e(route('testimonial')); ?>" class="modern-dropdown-item">
                                <i class="fa fa-quote-left" style="margin-right: 8px; color: #6ecfe9;"></i>Testimonials
                            </a>
                            <a href="<?php echo e(route('team')); ?>" class="modern-dropdown-item">
                                <i class="fa fa-users" style="margin-right: 8px; color: #6ecfe9;"></i>Team
                            </a>
                            <a href="<?php echo e(route('job_vacancy')); ?>" class="modern-dropdown-item">
                    ...
                    <li class="modern-nav-item">
                        <a href="<?php echo e(route('accommodation')); ?>" class="modern-nav-link modern-dropdown-toggle">The Lodge</a>
                        <!-- Mega Menu -->
                        <div class="mega-menu">
                            <div class="mega-menu-grid">
                                <a href="<?php echo e(route('accommodation')); ?>" class="mega-menu-item">
                                ...
                                <a href="<?php echo e(route('admission')); ?>" class="mega-menu-item">
                                    <div class="mega-menu-icon">
                                ...
                                <a href="<?php echo e(route('facilities')); ?>" class="mega-menu-item">
                                    <div class="mega-menu-icon">
                                ...
                                <a href="<?php echo e(route('cuisine')); ?>" class="mega-menu-item">
                                    <div class="mega-menu-icon">
                                ...
                                <a href="<?php echo e(route('activities')); ?>" class="mega-menu-item">
                                    <div class="mega-menu-icon">
                                ...
                                <a href="<?php echo e(route('principal')); ?>" class="mega-menu-item">
                                    <div class="mega-menu-icon">
                                ...
                                <a href="<?php echo e(route('staff_training')); ?>" class="mega-menu-item">
                                    <div class="mega-menu-icon">
                    ...
                    <li class="modern-nav-item">
                        <a href="<?php echo e(route('vacancies')); ?>" class="modern-nav-link">Bed Availability</a>
                    </li>

                    <li class="modern-nav-item">
                        <a href="<?php echo e(route('gallery')); ?>" class="modern-nav-link">Gallery</a>
                    </li>

                    <li class="modern-nav-item">
                        <a href="<?php echo e(route('contact')); ?>" class="modern-nav-link modern-cta-button">Contact Us</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="floating-actions">
    ...
    <a href="<?php echo e(route('contact')); ?>" class="floating-btn" data-tooltip="Book a Tour">
...
<!-- mian-content -->
<div class="main-content" ><?php /**PATH /var/www/resources/views/inc/navbar.blade.php ENDPATH**/ ?>