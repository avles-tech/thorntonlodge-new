...
@section('content')
    <section class="about">
        <img src="/images/slider/thorntonlodgeb9.jpg" style="width: 100%; "/>
        <h3 class="tittle banner-title">Gallery</h3>
    </section>
    <section class="about py-lg-5 py-md-5 py-2">
        <div class="container">
            <div class="inner-sec-w3pvt py-lg-1 py-3">
                <!-- services -->
                <div class="fetured-info pt-lg-2">
                    <h3 class="tittle text-center my-lg- mb-3">{{  $tag_info->title }} Gallery</h3>
