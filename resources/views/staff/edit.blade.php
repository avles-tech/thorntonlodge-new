...
@section('content')
    ...
    <div class="right_col" role="main">
        ...
        <div class="">
            ...
            {!! Form::open(['action' => ['StaffController@update'], 'class' => 'form-horizontal form-label-left','role' => 'form', 'method' => 'POST', 'enctype'=>'multipart/form-data']) !!}
                                    ...
                                    <div class="widget-main">
                                        <div class="form-group">
                                            <div class="fallback col-sm-12 text-center" >
                                                <img class="well" id="myImg" style="width:185px;height:185px;" src="{{ asset((!isset($staff->image)) ? 'Uploads/staff_images/default-user.png' : 'Uploads/staff_images/'.$staff->image ) }}" class="img-responsive" alt="Staff {{$staff->name}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <input name="image" accept="image/x-png,image/gif,image/jpeg" type="file" id="id-input-file-1" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" required name="name" value="{{ $staff->name }}" placeholder="Staff Name ..." class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                <textarea name="bio" placeholder="Staff bio (optional)..." class="form-control" rows="5">{{ $staff->bio }}</textarea>
                                </div>
                            </div>
