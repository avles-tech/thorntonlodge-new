            ...
            <div class="row footer-top mb-md-5 mb-4">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 footer-grid_section_1its ml-lg-auto" data-aos="fade-left">
                    ...
                    <ul class="links">
                        ...
                        <li><a href="{{ route('admission') }}">Admission Criteria</a></li>
                        <li><a href="{{ route('facilities') }}">Facilities</a></li>
                        <li><a href="{{ route('activities') }}">Activities & Events</a></li>
                        <li><a href="{{ route('principal') }}">Principal of Care</a></li>
                        <li><a href="{{ route('staff_training') }}">Staff Training</a></li>
                    </ul>
                </div>
            </div>
...
<div class="cpy-right text-center py-4">
    ...
    <p class="copy-w3layouts">Thornton Lodge © {{date('Y')}}. All Rights Reserved. | Website developed by <a href="http://adameveandapple.co.uk/">AdamEve&Apple</a></p>
</div>
<!-- //copyright -->