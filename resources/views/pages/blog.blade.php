...
@section('content')
    ...
    <section class="about" style="margin-top: -25px;">
        <div class="container-2">
            ...
            <h3 class="bottom-left">NEWS</h3>
    </section>
    <!-- //main-content -->
    <section class="ab-info-main py-md-2 py-2">
        <div class="container">
            <div class="inner-sec-w3pvt py-lg-2">
                <div class="blog-sec">
                    <h3 class="tittle text-center mb-lg-2 mb-1 inner-tittle"></h3>
                                    ...
                                    @if(count($tags)>0)
                                        @foreach($tags as $k=>$tag)
                                            <a href="/category-{{$tag->slug}}">
                                                <li class="list-group-item <?php if($k==1){ echo 'active'; } ?>">{{ $tag->name }}
